...
import type { Category, CreateSkillRequest, ApiError } from '../types'
...
const Submit = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (apiError.status === 401) {
        ...
        setError(apiError.message || 'Invalid data. Please check your inputs.')
      } else {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Submit Skill</h1>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Must be lowercase. This will be part of your skill's unique
              identifier.
            </p>
          </div>
